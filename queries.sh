...
echo "$($PSQL "SELECT name FROM games JOIN teams ON teams.team_id = games.winner_id WHERE  round = 'Eighth-Final' AND year = 2014 UNION SELECT name FROM games JOIN teams ON teams.team_id = games.opponent_id WHERE round = 'Eighth-Final' AND year = 2014")"
